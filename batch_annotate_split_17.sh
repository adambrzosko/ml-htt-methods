...
python annotate_file_split_17.py filelist/tmp_2017_split/tt/x${inputNumber} IC_01Jun2020 --model_folder ./data_tauspinner_01Jun2020_2017/ --output-folder /vols/cms/dw515/Offline/output/SM/cpprod_2017/ --training tauspinner --era 2017 --channel tt --config-training data_tauspinner_01Jun2020_2017/tt_2017_config_inc.yaml &> filelist/tmp_2017_split/tt/${inputNumber}.log 
