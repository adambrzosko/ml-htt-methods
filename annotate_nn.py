...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        default=[
            ...
            "tt_training_9May_tests/tt_fold0_scaler.pkl"	#not sure what this is
        ],
        help=
    ...
    parser.add_argument(
        "--training", default="JHU", help="Name of training to use.")  #not sure what this is
    parser.add_argument(
        "--mjj", default="high", help="mjj training to use.")	#don't know what that is
    parser.add_argument(
...
def main(args, config, file_names):
    ...
    path = "/vols/cms/dw515/Offline/output/SM/cpprod_2018/"
