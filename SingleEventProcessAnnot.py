...
def main(args, config):
    ...
    branch_scores = tree.Branch("{}_scores_1".format(
    ...
    for i_event in range(tree.GetEntries()):
        ...
        if m_sv > 0:
            ...
            response_scores = model.predict(test1) #have to properly feed the whole event with the images #.predict_prova?
            response_scores2 = model.predict(test2)
